...
This experiment optimizes the laser and gas parameters to manufacture high-quality laser-induced graphene, by maximizing the `target` value. Further details refer to [our paper (Wahab et al. 2020)](https://www.sciencedirect.com/science/article/pii/S0008622320305285) - note however that `mlrMBO` was used in that publication.
...
This is the next parameters that we should run in our experiment! If we chose to evaluate this point, the `target` can then be updated - here, we arbritrarily input the value `target = 3`.
